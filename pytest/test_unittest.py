...
class Test_TestAgent(unittest.TestCase):
    ...
    def test_hashingMove(self):
        ...
        assert hash2 == hash3, "Hashes after move are not equal1"

        hash4 = agent.undoUpdatezTableFromMove(hash3,move)

        assert hash1 == hash4, "Hashes after undomove are not equal2"
    ...
    def test_evalPositionOfFigure(self):
        ...
        assert eval1 > eval2, "Eval position of figure is wrong"
        
    def test_moveError(self):
